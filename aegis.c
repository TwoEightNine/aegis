...
void test_128() {
    ...
    aegis_128_encrypt(key, iv, plain, plain_len, ad, ad_len, tag, cipher);
    ...
    uint8_t success = aegis_128_decrypt(key, iv, cipher, plain_len, ad, ad_len, tag, decr);
    printf("plain  = ");
